...
import { MultiPageButtons } from './multi-page-buttons';
import { MultiPageButtonsProps as Props } from '../../../types';

describe('MultiPageButtons', () => {
    let props: Props;
    ...
    it('should match snapshot', () => {
        const wrapper = shallow(<MultiPageButtons {...props} skip={5} />);
    ...
    `('should render correct array of buttons for current page of $currentPage', ({ currentPage, expectedButtons }) => {
        const wrapper = shallow(<MultiPageButtons {...props} currentPage={currentPage} />);
    ...
    it('should disabled skip forward button if skip value is greater than remaining buttons', () => {
        const wrapper = shallow(<MultiPageButtons {...props} currentPage={6} skip={5} />);
    ...
    it('should render less buttons if there are less pages than requested buttons to display', () => {
        const wrapper = shallow(<MultiPageButtons {...props} numberOfPages={4} />);
